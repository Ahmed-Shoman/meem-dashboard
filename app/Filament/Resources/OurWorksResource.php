   ...
   public static function table(Table $table): Table
{
    return $table
        ->columns([
            ...
            Tables\Columns\TextColumn::make('listeners_stat')
                ->label('Listeners Stat'),

            Tables\Columns\TextColumn::make('listeners_stat_description')
                ->label('Listeners Sub Stat'),

            Tables\Columns\TextColumn::make('episodes_stat')
                ->label('Episodes Stat'),
            ...
            Tables\Columns\TextColumn::make('episodes_stat_description')
                ->label('Episodes Sub Stat'),

            Tables\Columns\TextColumn::make('programs_stat')
                ->label('Programs Stat'),

            Tables\Columns\TextColumn::make('programs_stat_description')
                ->label('Programs Sub Stat'),

            // Tables\Columns\ImageColumn::make('client_logos')
            //     ->label('Clients Logos'),
